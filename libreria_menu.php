...
if (isset($_SESSION["sesion_id_rol"])){
	...
	if ($cuerp == false){
		echo" <img src='../asociacion/logos/{$logo}' width='10%' >";
	}
	else {
		echo "<img src='privada/asociacion/logos/{$logo}' width='10%' >";
	}
                ...
                foreach ($rs as $r => $fila) {
                    ...
                    if ($cuerp == false or $cuerp == ""){
                        echo"<li><a onclick='location.href=\"../".$fila2["contenido"]."\"' ' style='cursor:pointer;'>".$fila2["opcion"]."</a></li>";
                                ...
                                echo"<li><a onclick='location.href=\"sis_atecom_cordero_2023/".$fila2["contenido"]."\"'  style='cursor:pointer;'>".$fila2["opcion"]."</a></li>";
                }
        }
        echo"</ul>";
    echo"</li>";
