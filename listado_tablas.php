...
$archivo = "archivo.txt";
$contador = intval(trim(file_get_contents($archivo))); // con file_....obtiene el valor del archivo y con trim impia el contenido y con intval convierte y con intval convierte el contendo a entero 
...
fclose($file);
//codigo para e contador de visitas
